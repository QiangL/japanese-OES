			...
			<div class="row">
				...
				<div class="span6 offset3" id="changeTab">
					...
					<div class="widget-body">
						<div id="tabContent">
							<a type="button" href="javascript:;" >教师信息</a> <br> <br>
							<a type="button" href="/japanese-OES/admin/students" > 学生信息</a>
						</div>
					</div>
				</div>

				<div class="span6 offset3" id="changeStudent">
					<h4 class="widget-header">教师信息管理</h4>
					<div class="widget-body">
						<table class="changeTable" id="t_student">
							...
							<c:forEach var="t" items="${teachers}" varStatus="i">
								<tr class="changeContentOn" id="tr_${i.count}">
									<td id="t_teacherId_${i.count}">${t.teacherId}</td>
									<td id="t_teacherName_${i.count}">${t.teacherName }</td>
									<td><input type="button" id="t" index="${i.count}" value="修改"
										class="btn change btn-primary btn-medium"> </td>
									<td><input type="button" id="t" index="${i.count}" value="删除"
					...
					<div class="widget-body">
						<div class="changeContentOff" id="changeContentOff">
							<form id="changeForm" name="changeForm" method="post">
								<span>教工号：</span> <input id="teacherId" type="text"
									style="width: 80px;" disabled="disabled" /> <br>
								<span>姓 &nbsp;&nbsp;&nbsp;名：</span> <input id="teacherName" type="text"
									style="width: 80px;" /> <br>
									 <input type="submit"
									id="changeConfirmTeacher" value="确定修改"
		...
		<div class="pagination pagination-centered">
			<ul>
				...
				<c:forEach varStatus="i" begin="1" end="${pageCount}">
					...
					<a href="/japanese-OES/admin/teachers?page=${i.count}">${i.count}
					</a>
					</li>
				</c:forEach>
			</ul>
